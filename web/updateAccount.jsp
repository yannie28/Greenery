	...
	<link rel="stylesheet" href="Bootstrap/css/bootstrap.css">
        ...
        <body>
            ...
            <div class="container-fluid">
                ...
                <%--<c:set var="list" value='${requestScope["details"]}' />--%>        
                <div class="faq">
                    <form action="UpdateUsers">
                        ...
                        <c:forEach items="${list}" var="item" varStatus="counter">
                            ...
                            <input type="text" name="firstname" value = "${item.getFirstname()}" required >
                            <h5 style="margin-bottom: -10px">First Name</h5>
                            
                            <input type="text" name="lastname" value = "${item.getLastname()}" required>
                            <h5 style="margin-bottom: -20px">Last Name</h5>

                            <input type="text" name="username" value = "${item.getUsername()}" required >
                            <h5 style="margin-bottom: -10px">Username</h5>

                            <input type="text" name="password" value= "${item.getPassword()}" required>
                            <h5 style="margin-bottom: -20px">Password</h5><br><br>
                                    
                            <input type="hidden" name="usertype" value="${item.getUsertype()}">
                                    
                            <input type="hidden" name="status" value="${item.getStatus()}">

                            <h4>
                                <button type="submit" name = "button" value="updateAccount" class="btn btn-default btn-lg" style="width: 100px; margin-top: 20px;">
                                    Update
                                </button>
                            </h4>
                        </c:forEach>
